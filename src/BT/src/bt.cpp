...
#define DEFAULT_BT_XML "/home/ros/bt_ws/src/BT/bt_xml/bt_nav_mememan.xml"
...
int main(int argc, char **argv)
{
    ...
    factory.registerNodeType<PublishGoal>("PublishGoal");
    ...
    while (rclcpp::ok() && status == NodeStatus::RUNNING) {
        status = tree.tickRoot(); //same as loop
