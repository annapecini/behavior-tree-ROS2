...
Pose2D convertFromString(BT::StringView key)
{
    ...
    else
    {
        ...
        output.quaternion_z = BT::convertFromString<double>(parts[2]);
        output.quaternion_w = BT::convertFromString<double>(parts[3]);
	return output;
    }
}
